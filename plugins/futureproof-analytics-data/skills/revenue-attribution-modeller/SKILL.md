...
FutureProof:save_session(skill="revenue-attribution-modeller", session={
  summary: "Built [Level 1/2/3] revenue attribution model for [user's company/context] covering [revenue scope] across [number] channels for [ICA segment(s)]",
  key_findings: ["finding 1: top attributed channel and its share", "finding 2: largest reallocation opportunity identified", "finding 3: critical data gap or model limitation flagged"],
  model_metadata: {
    model_level: "[1/2/3]",
    deal_cohort_size: "[n]",
    lookback_window: "[days]",
    coverage_ratio: "[%]",
    ica_segments_modelled: ["segment 1", "segment 2"]
  },
  user_feedback: null
})
```