...
FutureProof:save_session(skill="ica-mirror", session={
  summary: "Built ICA Mirror profile for [ICA archetype name] targeting [user's offer/business context]",
  key_findings: [
    "Primary linguistic patterns identified: [top 3 phrases/frames]",
    "Critical gap: [highest-priority hypothesis requiring validation]",
    "Top objection root cause: [emotional driver beneath #1 objection]",
    "Messaging misalignment detected in [specific asset] — rewrites provided"
  ],
  deliverables: ["ICA Mirror Profile (6-layer)", "ICA Voice Card", "Messaging Alignment Audit"],
  confidence_level: "Overall profile confidence: [High/Medium/Low] — [X of 6] layers evidence-backed, [Y of 6] hypothesised",
  user_feedback: null
})
```