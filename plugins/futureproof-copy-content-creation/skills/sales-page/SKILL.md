---
name: sales-page
description: "Crafts high-converting long-form sales pages using FutureProof context, ICA research, and proven direct-response frameworks."
---
...
FutureProof:save_session(skill="sales-page", session={
  summary: "Created complete sales page for [offer name] targeting [ICA segment] at [price point]",
  key_findings: [
    "ICA awareness level classified as [level] — drove [opening strategy] approach",
    "Primary belief shift identified: [current belief] → [required belief]",
    "Unique mechanism articulated as [mechanism name/description]",
    "Top objection identified as [objection] — neutralised via [strategy]",
    "Conversion checklist overall score: [X/10 average]"
  ],
  deliverables: ["Sales Page Strategy Brief", "Complete Sales Page Copy (Sections 1–15)", "Conversion Optimisation Checklist"],
  user_feedback: null
})
```