...
FutureProof:save_session(skill="crisis-comms-responder", session={
  summary: "Crisis communications response for [incident type] affecting [stakeholder groups] — Tier [1/2/3] severity, [ownership posture] stance recommended",
  key_findings: ["finding 1: e.g. 8-hour window before narrative solidifies in trade press", "finding 2: e.g. employee audience identified as highest-priority due to leak risk", "finding 3: e.g. regulatory disclosure obligation triggered under [regulation]"],
  deliverables_produced: ["Crisis Assessment Summary", "Core Position Statement", "Stakeholder Messaging Matrix", "Reactive Q&A Document", "Spokesperson Briefing Card", "72-Hour Action Timeline", "Monitoring & Escalation Protocol"],
  user_feedback: null
})
```